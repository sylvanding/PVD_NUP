...
# -*- coding: utf-8 -*-
"""
13-clustered-csv2h5.py: 将核孔样本归一化并保存为H5格式
...
def main():
    ...
    OUTPUT_PATH = os.path.join(DATA_ROOT, "13-clustered-pc-blocks.h5")
    
    # 归一化参数
    TARGET_POINTS = 40  # 目标点数，确保所有样本点数一致
    CENTER = True  # 归一化到 [-1, 1]，否则 [0, 1]
    
    # ========== 执行转换 ==========
    logger = setup_logging()
    
    logger.info("开始将核孔样本CSV转换为H5格式...")
    ...
    denormalized = denormalize_minmax(points[sample_idx], min_vals[sample_idx], max_vals[sample_idx], center=CENTER)
